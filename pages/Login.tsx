...
const Login: React.FC<LoginProps> = ({ onLogin, residents }) => {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-3 sm:p-4 overflow-hidden bg-slate-900">
      ...
      <div className="max-w-md w-full bg-white rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden relative z-10">
        <div className="bg-white p-6 sm:p-8 text-center border-b border-slate-100">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-slate-800 font-serif">ŞENGEL RESIDENCE</h2>
          <p className="text-slate-500 mt-1 text-xs sm:text-sm font-medium uppercase tracking-wide">Site Yönetim Sistemi</p>
        </div>

        <div className="flex border-b border-slate-200">
          <button
            className={`flex-1 py-3 sm:py-4 text-xs sm:text-sm font-medium transition-colors touch-manipulation ${
              activeTab === 'user'
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            <div>
              ...
              <div className="relative">
                <span className="absolute left-3 top-3.5 sm:top-2.5 text-slate-400">
                  {activeTab === 'user' ? (
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 sm:py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 outline-none transition-all text-base touch-manipulation"
                  required
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full py-3.5 sm:py-3 bg-slate-900 hover:bg-slate-800 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5 flex items-center justify-center touch-manipulation text-base sm:text-sm"
            >
      ...
      <div className="absolute bottom-2 sm:bottom-4 text-white/40 text-xs z-10 text-center w-full px-4">
